...
export const referralContent = {
  pt: {
    meta: {
      ...
      description:
        "Indique empresas para a Agnus e ganhe R$450 por cada cliente fechado.",
    },
    hero: {
      badge: "INDIQUE E GANHE",
      titleLine1: "Ganhe R$450 por cada",
    ...
    form: {
      ...
      fields: {
        ...
        yourPhonePlaceholder: "(27) 99999-9999",
        yourEmail: "",
        yourEmailPlaceholder: "",
        payout: "Chave PIX",
        payoutPlaceholder: "CPF, e-mail, telefone ou aleatória",
        payoutOptions: [] as string[],
    ...
    how: {
      ...
      steps: [
        ...
        {
          number: "05",
          title: "Receba R$450,00 por cliente fechado 🤝",
          text: "Você receberá R$450,00 a cada indicação fechada (assinatura do primeiro contrato). E pode indicar quantas vezes quiser!",
        },
      ],
    },
    footer: {
  ...
  en: {
    meta: {
      ...
      description:
        "Refer companies to Agnus and earn $300 USD for every closed client.",
    },
    hero: {
      badge: "REFER AND EARN",
      titleLine1: "Earn $300 USD for every",
    ...
    form: {
      ...
      fields: {
        ...
        companyNamePlaceholder: "Referred business name",
        contactPerson: "Business contact name",
        contactPersonPlaceholder: "Referred business contact",
        referredPhone: "Business phone number",
        referredPhonePlaceholder: "+1 555 555 5555",
        instagramOrSite: "Website or Instagram (optional)",
        instagramOrSitePlaceholder: "If available",
        talkedAbout: "Has this business spoken with Agnus before?",
        ...
        yourPhonePlaceholder: "+1 555 555 5555",
        yourEmail: "Your email",
        yourEmailPlaceholder: "you@email.com",
        payout: "Preferred payout method",
        payoutPlaceholder: "Select a payout method..",
        payoutOptions: [
          "Wise",
          "PayPal",
          "Payoneer",
        ...
        commentPlaceholder: "Tell us a bit about the business",
      },
      ...
      steps: [
        {
          ...
          list: [
            ...
            "Strategic audiovisual production;",
        ...
        {
          number: "05",
          title: "Receive $300 USD for every closed client 🤝",
          text: "You will receive $300 USD for every closed referral (after the first contract is signed). You can refer as many companies as you want!",
        },
      ],
    },
    footer: {
