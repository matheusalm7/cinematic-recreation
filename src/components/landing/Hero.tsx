...
export const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-hero text-white">
      ...
      {/* White fade-out at the very bottom — sits behind the card and bleeds into the next section */}
      <div className="pointer-events-none absolute -bottom-24 inset-x-0 h-48 bg-gradient-to-b from-transparent via-background/60 to-background z-0" />
