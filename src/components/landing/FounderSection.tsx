...
const MatheusCard = ({ badgeIdSuffix }: { badgeIdSuffix: string }) => (
  <div className="relative w-full">
    ...
    <div className="hidden md:flex absolute -top-6 -right-6 h-24 w-24 lg:h-28 lg:w-28 items-center justify-center">
      <svg
        viewBox="0 0 200 200"
      ...
      >
        <defs>
          <path
            id={`founder-circle-${badgeIdSuffix}`}
            d="M 100,100 m -78,0 a 78,78 0 1,1 156,0 a 78,78 0 1,1 -156,0"
          />
        </defs>
        <text fontSize="18" fontWeight="500" letterSpacing="3" fill="currentColor">
          <textPath href={`#founder-circle-${badgeIdSuffix}`}>{circularText}</textPath>
        </text>
      </svg>
