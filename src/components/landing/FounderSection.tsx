  ...
  return (
    <section className="relative bg-background py-24 overflow-hidden">
      <div className="container relative z-10">
        ...
        {/* Bottom: Two portraits side-by-side */}
        <div className="mt-20 grid md:grid-cols-2 gap-12 md:gap-16 lg:gap-20">
          {founders.map((f) => (
            <div key={f.id} className="relative max-w-[560px] mx-auto w-full">
              {/* Portrait */}
              ...
              <div className="absolute -bottom-6 -right-4 sm:right-0 lg:-right-6 w-[78%] sm:w-[62%] bg-hero text-white p-6 sm:p-8 shadow-glow">
